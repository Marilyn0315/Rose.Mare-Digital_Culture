...
One example of fan discourse concerning problematic fan-content that I have encountered is the heterosexualization of a canonically homosexual character named Dorian Pavus in Dragon Age: Inquisition. For brief context, Dragon Age is an RPG game series set in a magical medieval fantasy setting. There is one playable character and they are accompanied by companions as they complete their journey. The playable character can become friends, enemies, and/or lovers with their companions, which sometimes impacts the story heavily. There is an approval system, so a companion's reaction to a choice the player makes can vary greatly depending on whether they have low or high approval. This particular change of sexuality with Dorian is more complicated for fans to come to a consensus with, because the character Dorian has a storyline that, with enough character approval, explores how Dorian’s father did not approve of his sexuality and essentially attempted conversion therapy against Dorian’s wishes. 

“Cultural appropriation and representation”: A few examples of fandom discontent I will dissect come from my own experiences in the Dragon Age fandom on Tumblr.  In Dragon Age, the world is called Thedas (The dragon age world setting), and within this world elves are a group of people who have faced genocide and discrimination for upwards of 940 years. There was much discourse for a time concerning the representation of people of colour in the fandom, who could create marginalized characters, and what choices could be ethically made in-game. 

The character Alistair Therein is beloved by a significant amount of fans, as evidenced by an extensive amount of fanart and fanfiction that is still being created to this day despite the game coming out in 2009. David Gaider is the original writer for the character Alistair, as well as one of the original creators of the first title of the series Dragon Age: Origins. That is all to say, he is one of the writers closest to the material for which the world of the four entries are based on. Alistair is found out to be elf-blooded in a book titled Asunder by David Gaider, which is not entirely known by the entire fandom as it is not information that can be gathered by playing the game (not everyone is an active enough fan to buy or even know about the books) and not every fan is invested in Alistair to begin with. Content creators have been criticized for not drawing or describing Alistair with elf-like ears or darker skin than what is portrayed in-game. The common citation for Alistair having darker skin comes from his canonical mother Fiona, an elf who appears in the book Asunder. There is no actual description of her skin tone, but my theory is that fans perhaps created an image of Fiona as a person of colour before Dragon Age Inquisition released because she is a marginalized character (which is a whole other problematic can of worms in its own right), which created a “fanon” (fan-made canon) that people interpreted as canon despite being false. In any case, creators have been accused of being racist and xenophobic for drawing Alistair as a white man, even though he appears pale in all versions of the texts. I would argue that the demand for content creators to draw and write these characters in a specific way reinforces racism and xenophobia as it is prescribing one identity to a specific tone of skin. To be clear, Alistair’s skin tone is of no concern to the story within the vacuum of Thedas. However, the reasons for which some fans criticize fan art is absurd– Alistair’s mother is from a marginalized group, therefore she must be a POC, and people who do not draw Alistair with obviously elven ears are racist. This line of thinking is reductive and not engaging critically with the text or reality. 

Based on the observations I have made within this discourse, I would argue that this push by fans to have Alistair appear more elven is an example of heterotopia. That is to say, fans who identify more with the marginalized characters (elves) in the text want to see more representation, and so the utopia would be seeing this 'mainstream' character that is widely loved represent the elven population. While I do not think there is anything inherently wrong with this perspective, the way in which fans go about sending hateful messages to other creators for not drawing Alistair the way that they would is deeply inappropriate and not suitable behaviour for a shared fandom space. I would note as well that the strong opinions concerning Alistair do often come from a source of affection. Many creators have followed the game series for more than 10 years, and so these characters are dear to them. When people create their beloved character in a way that they do not agree with, it can be upsetting. An example of how the game developers acknowledge long time fans is with small easter eggs. In Dragon Age Origins, Alistair often asks the playable character “Did you need something.” Although a small piece of dialogue, echoing this for fans who have heard Alistair ask this hundreds of times is very meaningful.  
...
### The Hunger Games Memes resurgence 
To be clear, I think this tiktok is cringy, but it still proves my point
https://vm.tiktok.com/ZMBXvThvS/
